               ...
               <div class="main_nav_content d-flex flex-row">
                  ...
                  <div class="cat_menu_container">
                     ...
                     <ul class="cat_menu">
                        ...
                        <li class="hassubs">
                           <a class="text-uppercase" href="{{ url('all/category/'.$cat->id) }}">{{ $cat->category_name }}<i class="fas fa-chevron-right"></i></a>
                           <ul>
                              @php
                                 $subcategory = DB::table('subcategories')->where('category_id',$cat->id)->get();
                              @endphp
                              @foreach ($subcategory as $row)
                              <li><a class="text-uppercase" href="{{ url('products/'.$row->id) }}">{{ $row->subcategory_name }}</a></li>
                              @endforeach
                           </ul>
                        </li>
                        @endforeach
                  ...
                  <div class="main_nav_menu ml-auto">
                     <ul class="standard_dropdown main_nav_dropdown">
                           ...
                           <li><a href="blog.html">Blog<i class="fas fa-chevron-down"></i></a></li>
                           <li><a href="{{ route('user.contact.page') }}">Contact<i class="fas fa-chevron-down"></i></a></li>
                     </ul>
                  </div>
